...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "kernels.gaussian_filter",
        "sources": [
            "/home/robinson/Documents/visTools/visTools_v2/core_functions/kernels/gaussian_filter.pyx"
        ]
    },
    "module_name": "kernels.gaussian_filter"
}
END: Cython Metadata */
...
#define __PYX_HAVE__kernels__gaussian_filter
#define __PYX_HAVE_API__kernels__gaussian_filter
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'kernels.gaussian_filter' */
static PyObject *__pyx_f_7kernels_15gaussian_filter_GaussianFilter(int, int, float, int __pyx_skip_dispatch); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t = { "float64_t", NULL, sizeof(__pyx_t_5numpy_float64_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "kernels.gaussian_filter"
extern int __pyx_module_is_main_kernels__gaussian_filter;
int __pyx_module_is_main_kernels__gaussian_filter = 0;

/* Implementation of 'kernels.gaussian_filter' */
...
static PyObject *__pyx_pf_7kernels_15gaussian_filter_GaussianFilter(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_w, int __pyx_v_h, float __pyx_v_sigma); /* proto */
...
static PyObject *__pyx_pw_7kernels_15gaussian_filter_1GaussianFilter(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_7kernels_15gaussian_filter_GaussianFilter(int __pyx_v_w, int __pyx_v_h, float __pyx_v_sigma, CYTHON_UNUSED int __pyx_skip_dispatch) {
  float __pyx_v_E;
  int __pyx_v_m;
  int __pyx_v_n;
 ...
 */
  ...
  /* "kernels/gaussian_filter.pyx":10
 *     cdef float E = 2.718281828459045
 *     cdef int m = int((w-1)/2)
 *     cdef int n = int((h-1)/2)             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float64_t,ndim=2] G = np.empty((h,w))
 ...
 */
  ...
  /* "kernels/gaussian_filter.pyx":11
 *     cdef int m = int((w-1)/2)
 *     cdef int n = int((h-1)/2)
 *     cdef np.ndarray[np.float64_t,ndim=2] G = np.empty((h,w))             # <<<<<<<<<<<<<<
 *     cdef double Gsum = 0.0
 ...
 */
  ...
  /* "kernels/gaussian_filter.pyx":12
 *     cdef int n = int((h-1)/2)
 *     cdef np.ndarray[np.float64_t,ndim=2] G = np.empty((h,w))
 *     cdef double Gsum = 0.0             # <<<<<<<<<<<<<<
 *     cdef int i,j
 ...
 */
  ...
  /* "kernels/gaussian_filter.pyx":14
 *     cdef double Gsum = 0.0
 *     cdef int i,j
 *     for i in range(w):             # <<<<<<<<<<<<<<
 *         for j in range(h):
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    ...
    /* "kernels/gaussian_filter.pyx":15
 *     cdef int i,j
 *     for i in range(w):
 *         for j in range(h):             # <<<<<<<<<<<<<<
 *             G[j,i] = E**(-1*((i-m)**2+(j-n)**2)/(2*sigma**2))
 ...
 */
    ...
    for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
      ...
      /* "kernels/gaussian_filter.pyx":16
 *     for i in range(w):
 *         for j in range(h):
 *             G[j,i] = E**(-1*((i-m)**2+(j-n)**2)/(2*sigma**2))             # <<<<<<<<<<<<<<
 *             Gsum += G[j,i]
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_G.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_G.diminfo[0].strides, __pyx_t_14, __pyx_pybuffernd_G.diminfo[1].strides) = powf(__pyx_v_E, (__pyx_t_11 / __pyx_t_12));

      /* "kernels/gaussian_filter.pyx":17
 *         for j in range(h):
 *             G[j,i] = E**(-1*((i-m)**2+(j-n)**2)/(2*sigma**2))
 *             Gsum += G[j,i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_v_Gsum = (__pyx_v_Gsum + (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_G.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_G.diminfo[0].strides, __pyx_t_16, __pyx_pybuffernd_G.diminfo[1].strides)));
    }
  }

  /* "kernels/gaussian_filter.pyx":19
 *             Gsum += G[j,i]
 * 
 *     return G/Gsum             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyFloat_FromDouble(__pyx_v_Gsum); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyNumber_Divide(((PyObject *)__pyx_v_G), __pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
 ...
 */
  ...
  __Pyx_AddTraceback("kernels.gaussian_filter.GaussianFilter", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_G.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_7kernels_15gaussian_filter_1GaussianFilter(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_7kernels_15gaussian_filter_1GaussianFilter(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_w;
  int __pyx_v_h;
  float __pyx_v_sigma;
  PyObject *__pyx_r = 0;
  ...
  __Pyx_RefNannySetupContext("GaussianFilter (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_h)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("GaussianFilter", 1, 3, 3, 1); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_sigma)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("GaussianFilter", 1, 3, 3, 2); __PYX_ERR(0, 7, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "GaussianFilter") < 0)) __PYX_ERR(0, 7, __pyx_L3_error)
      }
    ...
    __pyx_v_sigma = __pyx_PyFloat_AsFloat(values[2]); if (unlikely((__pyx_v_sigma == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 7, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("GaussianFilter", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 7, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("kernels.gaussian_filter.GaussianFilter", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7kernels_15gaussian_filter_GaussianFilter(__pyx_self, __pyx_v_w, __pyx_v_h, __pyx_v_sigma);
...
static PyObject *__pyx_pf_7kernels_15gaussian_filter_GaussianFilter(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_w, int __pyx_v_h, float __pyx_v_sigma) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("GaussianFilter", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_7kernels_15gaussian_filter_GaussianFilter(__pyx_v_w, __pyx_v_h, __pyx_v_sigma, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  {"GaussianFilter", (PyCFunction)__pyx_pw_7kernels_15gaussian_filter_1GaussianFilter, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_gaussian_filter(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_gaussian_filter},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initgaussian_filter(void); /*proto*/
PyMODINIT_FUNC initgaussian_filter(void)
#else
PyMODINIT_FUNC PyInit_gaussian_filter(void); /*proto*/
PyMODINIT_FUNC PyInit_gaussian_filter(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_gaussian_filter(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_gaussian_filter(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("gaussian_filter", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_kernels__gaussian_filter) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "kernels.gaussian_filter")) {
      if (unlikely(PyDict_SetItemString(modules, "kernels.gaussian_filter", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init kernels.gaussian_filter", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init kernels.gaussian_filter");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
