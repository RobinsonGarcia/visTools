...
class kernel:
    def __init__(self,F=1,C=1):
        self.fd = {'x':np.array([[0,0,0],[-1,0,1],[0,0,0]]).T[np.newaxis,np.newaxis,:,:],'y':np.array([[0,0,0],[-1,0,1],[0,0,0]])[np.newaxis,np.newaxis,:,:]}

        self.sobel = {'x':np.array([[-1,0,1],[-2,0,2],[-1,0,1]]).T[np.newaxis,np.newaxis,:,:],'y':np.array([[-1,0,1],[-2,0,2],[-1,0,1]])[np.newaxis,np.newaxis,:,:]}
