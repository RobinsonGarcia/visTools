...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "visTools.src.aux.histogram",
        "sources": [
            "histogram.pyx"
        ]
    },
    "module_name": "visTools.src.aux.histogram"
}
END: Cython Metadata */
...
#define __PYX_HAVE__visTools__src__aux__histogram
#define __PYX_HAVE_API__visTools__src__aux__histogram
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'visTools.src.aux.histogram' */
static PyObject *__pyx_f_8visTools_3src_3aux_9histogram_histogram(PyArrayObject *, PyArrayObject *, PyArrayObject *, PyArrayObject *, int, int __pyx_skip_dispatch); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t = { "float64_t", NULL, sizeof(__pyx_t_5numpy_float64_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "visTools.src.aux.histogram"
extern int __pyx_module_is_main_visTools__src__aux__histogram;
int __pyx_module_is_main_visTools__src__aux__histogram = 0;

/* Implementation of 'visTools.src.aux.histogram' */
...
static PyObject *__pyx_pf_8visTools_3src_3aux_9histogram_histogram(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_x, PyArrayObject *__pyx_v_w, PyArrayObject *__pyx_v_bins, PyArrayObject *__pyx_v_xk, int __pyx_v_n); /* proto */
...
/* "visTools/src/aux/histogram.pyx":8
...
static PyObject *__pyx_pw_8visTools_3src_3aux_9histogram_1histogram(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_8visTools_3src_3aux_9histogram_histogram(PyArrayObject *__pyx_v_x, PyArrayObject *__pyx_v_w, PyArrayObject *__pyx_v_bins, PyArrayObject *__pyx_v_xk, int __pyx_v_n, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_nn;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_w.rcbuffer->pybuffer, (PyObject*)__pyx_v_w, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 8, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_bins.rcbuffer->pybuffer, (PyObject*)__pyx_v_bins, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 8, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_xk.rcbuffer->pybuffer, (PyObject*)__pyx_v_xk, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 8, __pyx_L1_error)
  }
  ...
  /* "visTools/src/aux/histogram.pyx":13
 ...
 */
  ...
  /* "visTools/src/aux/histogram.pyx":15
 *     cdef int nn = x.shape[0]
 * 
 *     cdef np.ndarray[np.float64_t,ndim=2] hist = np.zeros((nn,n+1))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_nn); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_hist.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
  ...
  /* "visTools/src/aux/histogram.pyx":17
 *     cdef np.ndarray[np.float64_t,ndim=2] hist = np.zeros((nn,n+1))
 * 
 *     cdef np.ndarray[np.float64_t,ndim=2] G = np.zeros((nn,9))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_nn); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_G.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
  ...
  /* "visTools/src/aux/histogram.pyx":21
 *     cdef int i,ii,j
 * 
 *     for i in range(nn):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "visTools/src/aux/histogram.pyx":22
 * 
 *     for i in range(nn):
 *         G[i,:] = GaussianFilter(3,3,1.5*xk[i,3]).flatten()             # <<<<<<<<<<<<<<
 * 
 * 
 */
    __pyx_t_4 = __Pyx_GetModuleGlobalName(__pyx_n_s_GaussianFilter); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 22, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_10 = __pyx_v_i;
    __pyx_t_11 = 3;
    __pyx_t_5 = PyFloat_FromDouble((1.5 * (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_xk.rcbuffer->pybuffer.buf, __pyx_t_10, __pyx_pybuffernd_xk.diminfo[0].strides, __pyx_t_11, __pyx_pybuffernd_xk.diminfo[1].strides)))); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 22, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_3 = NULL;
    __pyx_t_12 = 0;
    ...
    if (PyFunction_Check(__pyx_t_4)) {
      PyObject *__pyx_temp[4] = {__pyx_t_3, __pyx_int_3, __pyx_int_3, __pyx_t_5};
      __pyx_t_2 = __Pyx_PyFunction_FastCall(__pyx_t_4, __pyx_temp+1-__pyx_t_12, 3+__pyx_t_12); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 22, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    } else
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_4)) {
      PyObject *__pyx_temp[4] = {__pyx_t_3, __pyx_int_3, __pyx_int_3, __pyx_t_5};
      __pyx_t_2 = __Pyx_PyCFunction_FastCall(__pyx_t_4, __pyx_temp+1-__pyx_t_12, 3+__pyx_t_12); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 22, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    } else
    #endif
    {
      ...
      __pyx_t_5 = 0;
      __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_13, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 22, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
    }
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_flatten); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 22, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = NULL;
    ...
    __pyx_t_4 = 0;
    if (unlikely(PyObject_SetItem(((PyObject *)__pyx_v_G), __pyx_t_2, __pyx_t_1) < 0)) __PYX_ERR(0, 22, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  }

  /* "visTools/src/aux/histogram.pyx":25
 * 
 * 
 *     for ii in range(nn):             # <<<<<<<<<<<<<<
 *         for i in x[ii,:]:
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "visTools/src/aux/histogram.pyx":26
 * 
 *     for ii in range(nn):
 *         for i in x[ii,:]:             # <<<<<<<<<<<<<<
 *             for j in range(n+1):
 *                 if i < bins[j]:
 */
    __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_ii); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 26, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    ...
    __pyx_t_1 = 0;
    __pyx_t_1 = PyObject_GetItem(((PyObject *)__pyx_v_x), __pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 26, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    if (likely(PyList_CheckExact(__pyx_t_1)) || PyTuple_CheckExact(__pyx_t_1)) {
      ...
      __pyx_t_14 = -1; __pyx_t_2 = PyObject_GetIter(__pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 26, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_15 = Py_TYPE(__pyx_t_2)->tp_iternext; if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 26, __pyx_L1_error)
    }
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    for (;;) {
      if (likely(!__pyx_t_15)) {
        if (likely(PyList_CheckExact(__pyx_t_2))) {
          ...
          __pyx_t_1 = PyList_GET_ITEM(__pyx_t_2, __pyx_t_14); __Pyx_INCREF(__pyx_t_1); __pyx_t_14++; if (unlikely(0 < 0)) __PYX_ERR(0, 26, __pyx_L1_error)
          #else
          __pyx_t_1 = PySequence_ITEM(__pyx_t_2, __pyx_t_14); __pyx_t_14++; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 26, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
          #endif
        } else {
          if (__pyx_t_14 >= PyTuple_GET_SIZE(__pyx_t_2)) break;
          #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_1 = PyTuple_GET_ITEM(__pyx_t_2, __pyx_t_14); __Pyx_INCREF(__pyx_t_1); __pyx_t_14++; if (unlikely(0 < 0)) __PYX_ERR(0, 26, __pyx_L1_error)
          #else
          __pyx_t_1 = PySequence_ITEM(__pyx_t_2, __pyx_t_14); __pyx_t_14++; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 26, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
          #endif
      ...
      __pyx_t_12 = __Pyx_PyInt_As_int(__pyx_t_1); if (unlikely((__pyx_t_12 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 26, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_v_i = __pyx_t_12;

      /* "visTools/src/aux/histogram.pyx":27
 *     for ii in range(nn):
 *         for i in x[ii,:]:
 *             for j in range(n+1):             # <<<<<<<<<<<<<<
 *                 if i < bins[j]:
 ...
 */
      ...
      for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_16; __pyx_t_12+=1) {
        ...
        /* "visTools/src/aux/histogram.pyx":28
 *         for i in x[ii,:]:
 *             for j in range(n+1):
 *                 if i < bins[j]:             # <<<<<<<<<<<<<<
 *                     hist[ii,j]+=w[ii,j]*G[ii,i]
 ...
 */
        ...
        __pyx_t_18 = ((__pyx_v_i < (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_bins.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_bins.diminfo[0].strides))) != 0);
        if (__pyx_t_18) {

          /* "visTools/src/aux/histogram.pyx":29
 *             for j in range(n+1):
 *                 if i < bins[j]:
 *                     hist[ii,j]+=w[ii,j]*G[ii,i]             # <<<<<<<<<<<<<<
 *                     break
 ...
 */
          ...
          *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_hist.rcbuffer->pybuffer.buf, __pyx_t_23, __pyx_pybuffernd_hist.diminfo[0].strides, __pyx_t_24, __pyx_pybuffernd_hist.diminfo[1].strides) += ((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_w.rcbuffer->pybuffer.buf, __pyx_t_19, __pyx_pybuffernd_w.diminfo[0].strides, __pyx_t_20, __pyx_pybuffernd_w.diminfo[1].strides)) * (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_G.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_G.diminfo[0].strides, __pyx_t_22, __pyx_pybuffernd_G.diminfo[1].strides)));

          /* "visTools/src/aux/histogram.pyx":30
 *                 if i < bins[j]:
 *                     hist[ii,j]+=w[ii,j]*G[ii,i]
 *                     break             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "visTools/src/aux/histogram.pyx":32
 *                     break
 * 
 *     return hist             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_AddTraceback("visTools.src.aux.histogram.histogram", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_G.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_8visTools_3src_3aux_9histogram_1histogram(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_8visTools_3src_3aux_9histogram_1histogram(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_w,&__pyx_n_s_bins,&__pyx_n_s_xk,&__pyx_n_s_n,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_w)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("histogram", 1, 5, 5, 1); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_bins)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("histogram", 1, 5, 5, 2); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_xk)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("histogram", 1, 5, 5, 3); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_n)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("histogram", 1, 5, 5, 4); __PYX_ERR(0, 8, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "histogram") < 0)) __PYX_ERR(0, 8, __pyx_L3_error)
      }
    ...
    __pyx_v_xk = ((PyArrayObject *)values[3]);
  ...
  __Pyx_RaiseArgtupleInvalid("histogram", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 8, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("visTools.src.aux.histogram.histogram", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_bins), __pyx_ptype_5numpy_ndarray, 1, "bins", 0))) __PYX_ERR(0, 10, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_xk), __pyx_ptype_5numpy_ndarray, 1, "xk", 0))) __PYX_ERR(0, 11, __pyx_L1_error)
  __pyx_r = __pyx_pf_8visTools_3src_3aux_9histogram_histogram(__pyx_self, __pyx_v_x, __pyx_v_w, __pyx_v_bins, __pyx_v_xk, __pyx_v_n);
...
static PyObject *__pyx_pf_8visTools_3src_3aux_9histogram_histogram(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_x, PyArrayObject *__pyx_v_w, PyArrayObject *__pyx_v_bins, PyArrayObject *__pyx_v_xk, int __pyx_v_n) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_bins;
  __Pyx_Buffer __pyx_pybuffer_bins;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_w;
  __Pyx_Buffer __pyx_pybuffer_w;
  ...
  __pyx_pybuffernd_xk.diminfo[0].strides = __pyx_pybuffernd_xk.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_xk.diminfo[0].shape = __pyx_pybuffernd_xk.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_xk.diminfo[1].strides = __pyx_pybuffernd_xk.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_xk.diminfo[1].shape = __pyx_pybuffernd_xk.rcbuffer->pybuffer.shape[1];
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_8visTools_3src_3aux_9histogram_histogram(__pyx_v_x, __pyx_v_w, __pyx_v_bins, __pyx_v_xk, __pyx_v_n, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  {"histogram", (PyCFunction)__pyx_pw_8visTools_3src_3aux_9histogram_1histogram, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_visTools__src__aux__histogram) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "visTools.src.aux.histogram")) {
      if (unlikely(PyDict_SetItemString(modules, "visTools.src.aux.histogram", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "visTools/src/aux/histogram.pyx":1
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_INCREF(__pyx_n_s_GaussianFilter);
  __Pyx_GIVEREF(__pyx_n_s_GaussianFilter);
  PyList_SET_ITEM(__pyx_t_1, 0, __pyx_n_s_GaussianFilter);
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_visTools_src_aux_kernels_Gaussia, __pyx_t_1, -1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_GaussianFilter); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_GaussianFilter, __pyx_t_1) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "visTools/src/aux/histogram.pyx":2
 * from visTools.src.aux.kernels.GaussianFilter import GaussianFilter
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * cimport cython
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init visTools.src.aux.histogram", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init visTools.src.aux.histogram");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
