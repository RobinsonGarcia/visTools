...
static PyObject *__pyx_pf_14GaussianFilter_GaussianFilter(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_w, int __pyx_v_h, float __pyx_v_sigma) {
  ...
  __Pyx_RefNannySetupContext("GaussianFilter", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_14GaussianFilter_GaussianFilter(__pyx_v_w, __pyx_v_h, __pyx_v_sigma, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
